package com.rhodes.video.exoplayer;
...
/**
 * Created by xiet on 2016/3/23.
 */
public class ExoVideoView extends CompactVideoView implements SurfaceHolder.Callback,
...
//    private Button                 retryButton;
    ...
    protected void initWithContext(Context context) {
        ...
        audioCapabilitiesReceiver = new AudioCapabilitiesReceiver(this.mContext, this);
...
//
//        View root = LayoutInflater.from(context).inflate(R.id.root, null);
...
//            preparePlayer(true);
//        } else {
//            Toast.makeText(this.mContext, R.string.storage_permission_denied, Toast.LENGTH_LONG).show();
//            finish();
//        }
//    }
      ...
      case Util.TYPE_HLS:
        return new HlsRendererBuilder(this, userAgent, contentUri.toString());*/
            case Util.TYPE_OTHER:
                return new ExtractorRendererBuilder(this.mContext, userAgent, contentUri);
            default:
...
//        updateButtonVisibilities();
    ...
    public void onError(Exception e) {
        ...
        if (e instanceof UnsupportedDrmException) {
            ...
            errorString = context.getString(Util.SDK_INT < 18 ? R.string.error_drm_not_supported
            ...
            if (decoderInitializationException.decoderName == null) {
                ...
                errorString = context.getString(R.string.error_instantiating_decoder, decoderInitializationException.decoderName);
            }
        }
        if (errorString != null) {
